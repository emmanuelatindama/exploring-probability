...
Fifteen games live here, in this order:
...
8. **Parrondo's paradox.** Two losing games mixed into a winning one. The
   stationary distribution of a 3-state Markov chain (capital mod 3) is a
   linear-algebra problem, not a simulation.

9. **Base rates and the 95% test.** Bayes' theorem applied to a screening
...
10. **The birthday problem.** Collision probability among n items drawn from d
...
11. **The secretary problem.** Optimal stopping over a random permutation --
...
12. **The two-envelope paradox.** The "always swap" argument needs an
...
13. **Optional stopping.** Repeated significance testing as gambler's ruin: a
...
14. **Simpson's paradox.** Two treatments across an easy and a hard subgroup.
...
15. **Bertrand's paradox.** Three sampling rules for "a random chord", three
